...
class BasicNetworkTest {
    ...
    public void dataConfig()
    {
        ...
        NormalizationUtils.dataToFile(data, "/home/qiaoyang/BangSun/encog-java-core/src/main/resources/trainData/test.csv");

        NormalizationHelper helper = data.getNormHelper();
        System.out.println(helper.toString());
        NormalizationUtils.persistModel(helper, "/home/qiaoyang/BangSun/encog-java-core/src/main/resources/Helper/helper.txt");
    ...
    public void evaluate(File file) {
        ...
        NormalizationHelper helper = NormalizationUtils.reloadPersistModel("/home/qiaoyang/BangSun/encog-java-core/src/main/resources/Helper/helper.txt");
