 ...
 */
public class EncogModel implements Serializable {
    ...
    *   这是我加的
    ...
    public void setMinStepImprove(double minStepImprove) {
        this.minStepImprove = minStepImprove;
    }

    private int maxTolerance = 10;
    private double minStepImprove = 0.01;
